...
export class DialogAdapter extends EventEmitter {
  ...
  constructor() {
    ...
    this.enableAgoraRTC = false; // agora RTC instead of Agora Live Mode 
  ...
  async _manageSubscriptions() {
    ...
    // NOT PUB
    if (this._load_music) {
      if (this._audioPublishers['load_music']) {
        expectedAudioSubs['load_music'] = this._audioPublishers['load_music'];
      }
      if (this._videoPublishers['load_music']) {
        expectedVideoSubs['load_music'] = this._videoPublishers['load_music'];
      }
    }
    if (this._load_dancer) {
      if (this._audioPublishers['load_dancer']) {
        expectedAudioSubs['load_dancer'] = this._audioPublishers['load_dancer'];
      }
      if (this._videoPublishers['load_dancer']) {
        expectedVideoSubs['load_dancer'] = this._videoPublishers['load_dancer'];
      }
    }
    //E NOT PUB
